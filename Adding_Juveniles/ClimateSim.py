...
def simulation(RCP_data, SiteIndex, Iterations, policy_number):
    ...
    soln_list = np.array([Obj_solutions, cost_solutions, damage_solutions,J_solutions, Y_solutions, M_solutions,I_solutions, Redsnag_solutions,Greysnag_solutions,B_SDDsolutions])
    col_names = ['Objective','Costs', 'Damages','J','Y','M','I', 'Redsnag', 'Greysnag','B_SDDsolutions'];
    df = pd.DataFrame()
