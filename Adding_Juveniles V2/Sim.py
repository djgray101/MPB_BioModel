...
def simulation(RCP_data, SiteIndex, Iterations, L):
    ...
    soln_list = np.array([Obj_solutions, cost_solutions, damage_solutions,J_solutions, Y_solutions, M_solutions,I_solutions, Harvest_solutions, Redsnag_solutions,Greysnag_solutions, B_solutions, B_SDDsolutions, I_LDDsolutions])
    col_names = ['Objective','Costs', 'Damages','J','Y','M','I', 'Harvest', 'Redsnag', 'Greysnag', 'B', 'B_SDD','I_LDD']
    df = pd.DataFrame()
